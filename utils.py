...
def split_dataset(cfg):
    ...
    dataset = datasets.ImageFolder(cfg.folder.dataset)
...
def create_dataloader(cfg):
    ...
    val_dataloader = DataLoader(val_dataset, batch_size=cfg.dataloader.batch_size, shuffle=True)
    test_dataloader = DataLoader(test_dataset, batch_size=cfg.dataloader.batch_size, shuffle=True)
